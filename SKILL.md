...
If `program-truth bootstrap` is available and local execution is appropriate, prefer this order:
...
4. only fall back to pure chat bootstrap when the npm CLI is unavailable or cannot be run
